    ...
    <div className="min-h-screen bg-[#0f0a1e] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-violet-400 text-sm mt-1">Start chatting with your team today</p>
        </div>

        <div className="bg-[#160d2e] border border-violet-900/40 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="text-violet-300 text-sm font-medium">Name</label>
          ...
          <p className="text-center text-sm text-violet-500 mt-6">
            ...
            <Link href="/login" className="text-violet-300 hover:text-white transition-colors">
              Sign in
            </Link>
          </p>
        </div>
